...
import ics.co.ke.businessaccount.model.BSend;
import ics.co.ke.businessaccount.model.BTransfer;
import ics.co.ke.businessaccount.model.BWithdrawal;
import ics.co.ke.businessaccount.model.DePo;
import ics.co.ke.businessaccount.model.PTransfer;
import ics.co.ke.businessaccount.model.PWithdrawal;
import ics.co.ke.businessaccount.model.Trader;
import ics.co.ke.businessaccount.model.Transaction;
import ics.co.ke.businessaccount.model.User;
import ics.co.ke.businessaccount.pojo.BSendPojo;
...
public class DataBaseAdapter {
    ...
    public static final String TABLE_REPORT = "Transaction_report";
    ...
    private static final String COLUMN_CREBIT = "credit";
    private static final String COLUMN_NATIONAL_ID = "national_id";
    ...
    public static final String CREATE_TABLE_REPORT = "CREATE TABLE " + TABLE_REPORT + "("
            ...
            + COLUMN_DATE + " TEXT,"
            + COLUMN_TRADER_ID + " TEXT,"
            + COLUMN_TRADER_USER_NAME + " TEXT,"
            + COLUMN_PAYMENT_MODE + " TEXT,"
    ...
    public void addDeposits(Transaction transaction) {
        db = dbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_TRANSACTION_ID, transaction.getTransaction_id());
        values.put(COLUMN_USER_NAME, transaction.getUsername());
        values.put(COLUMN_NATIONAL_ID, transaction.getNational_id());
        values.put(COLUMN_PHONE_NO, transaction.getPhone_Number());
        values.put(COLUMN_USER_PIN, transaction.getUser_Pin());
        values.put(COLUMN_BANK_NAME, transaction.getBank_Name());
        values.put(COLUMN_SS_TYPE_ACCOUNT, transaction.getAccount_type());
        values.put(COLUMN_BANK_ACOUNT_NUMBER, transaction.getBank_account_number());
        values.put(COLUMN_RECIPIENT_NUMBER, transaction.getRecipient_number());
        values.put(COLUMN_TRADER_ID, transaction.getTrader_id());
        values.put(COLUMN_TRADER_USER_NAME, transaction.getTrader_username());
        values.put(COLUMN_PAYMENT_MODE, transaction.getPayment_mode());
        values.put(COLUMN_TRADER_NUMBER, transaction.getTrader_number());
        values.put(COLUMN_AGENT_NUMBER, transaction.getAgent_number());
        values.put(COLUMN_AMOUNT, transaction.getAmount());
        values.put(COLUMN_CREBIT, "CR");
       ...
       public void addWithdrawals(Transaction transaction) {
        db = dbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_TRANSACTION_ID, transaction.getTransaction_id());
        values.put(COLUMN_USER_NAME, transaction.getUsername());
    ...
    public List<Transaction> getAllDepositsTransaction() {
        ...
        String[] columns = {
                ...
                COLUMN_USER_PIN,
                COLUMN_BANK_NAME,
                COLUMN_BANK_ACOUNT_NUMBER,
                COLUMN_SS_TYPE_ACCOUNT,
                COLUMN_RECIPIENT_NUMBER,
                COLUMN_DATE,
                COLUMN_TRADER_ID,
                COLUMN_TRADER_USER_NAME,
                COLUMN_PAYMENT_MODE,
                COLUMN_TRADER_NUMBER,
                COLUMN_AGENT_NUMBER,
                COLUMN_AMOUNT,
        };
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                transaction.setId(Integer.parseInt(cursor.getString(cursor.getColumnIndex(COLUMN_ID))));
