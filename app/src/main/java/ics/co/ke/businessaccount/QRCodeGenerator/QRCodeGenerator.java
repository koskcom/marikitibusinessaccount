package ics.co.ke.businessaccount.QRCodeGenerator;
...
public class QRCodeGenerator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.qr_code_generator_activity_main);
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        button_generate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(QRCodeGenerator.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_save) {
            ...
            LayoutInflater layoutInflater = LayoutInflater.from(QRCodeGenerator.this);
