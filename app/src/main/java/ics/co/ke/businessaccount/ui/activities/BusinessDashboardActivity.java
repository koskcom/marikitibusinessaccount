...
import ics.co.ke.businessaccount.BUZNESAPI;
import ics.co.ke.businessaccount.QRCodeGenerator.QRCodeGenerator;
...
import ics.co.ke.businessaccount.qrcode.barcodeScanner.BarcodeScanner;
import ics.co.ke.businessaccount.ui.adapters.MyAdapter;
import ics.co.ke.businessaccount.ui.common.fragment.CenteredTextFragment;
import ics.co.ke.businessaccount.ui.common.menu.DrawerAdapter;
import ics.co.ke.businessaccount.ui.common.menu.DrawerItem;
import ics.co.ke.businessaccount.ui.common.menu.SimpleItem;
import ics.co.ke.businessaccount.ui.common.menu.SpaceItem;
import ics.co.ke.businessaccount.ui.common.menu.slidingrootnav.SlidingRootNav;
import ics.co.ke.businessaccount.ui.common.menu.slidingrootnav.SlidingRootNavBuilder;
import ics.co.ke.businessaccount.ui.views.BusinessBankTransferActivity;
import ics.co.ke.businessaccount.ui.views.CreditPurchaseStatementActivity;
import ics.co.ke.businessaccount.ui.views.CustomerCareActivity;
import ics.co.ke.businessaccount.ui.views.DepositFundsActivity;
import ics.co.ke.businessaccount.ui.views.DepositManagerActivity;
import ics.co.ke.businessaccount.ui.views.SendFundsBusinessActivity;
import ics.co.ke.businessaccount.ui.views.WithdrawFundsActivity;
import ics.co.ke.businessaccount.ui.views.WithdrawalManagerActivity;

/**
 * Created by yarolegovich on 25.03.2017.
 */

public class BusinessDashboardActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener, AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    @BindView(R.id.cardViewDepositsManager)
    CardView cardViewDepositsManager;
    @BindView(R.id.cardViewWithdrawalsManager)
    CardView cardViewWithdrawalsManager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_business_account);
      ...
      /*  txtvwdate = (TextView) findViewById(R.id.textviewbsDate);
        ...
        if (extras != null) {
            ...
            Toast.makeText(BusinessDashboardActivity.this, receivedString, Toast.LENGTH_LONG).show();
        }//end if
        ...
        cardViewDeposits.setOnClickListener(v -> {
            Intent depositsintent = new Intent(getApplicationContext(), DepositFundsActivity.class);
        ...
        cardViewSendFunds.setOnClickListener(v -> {
            Intent sendfundsIntent = new Intent(getApplicationContext(), SendFundsBusinessActivity.class);
        ...
        cardViewWithdrawFunds.setOnClickListener(v -> {
            ...
            sendfundsIntent.putExtra("balance", chkBalance); //savings balance
            sendfundsIntent.putExtra("key", CHECKING_KEY); //key used to store savings balance
            //sendfundsIntent.putExtra("key", SAVINGS_KEY);
            startActivity(sendfundsIntent);
        });

        cardViewBankFundsTransfer.setOnClickListener(v -> {
            Intent transferIntent = new Intent(getApplicationContext(), BusinessBankTransferActivity.class);
            //send both balances
        ...
        cardViewDepositsManager.setOnClickListener(v -> {
            Intent transferIntent = new Intent(getApplicationContext(), DepositManagerActivity.class);
            startActivity(transferIntent);
        });

        cardViewWithdrawalsManager.setOnClickListener(v -> {
            Intent transferIntent = new Intent(getApplicationContext(), WithdrawalManagerActivity.class);
            startActivity(transferIntent);
        });
    ...
    private void init() {
        ...
        mPager.setAdapter(new MyAdapter(BusinessDashboardActivity.this, ImgArray));
   ...
   /* public void removeLastItem(View view) {
    ...
    private class FetchLogout extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog mprogress = new ProgressDialog(BusinessDashboardActivity.this);
...
//                    finish();
        ...
        protected void onPostExecute(Void result) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    Intent intent = new Intent(getApplicationContext(), BusinessDashboardActivity.class);
                    startActivity(intent);
    ...
    public void getPrefs() {
        ...
        SharedPreferences BalancePref = getSharedPreferences(BusinessDashboardActivity.MY_BALANCE, MODE_PRIVATE);
        //retrieve checking and savings balances if they are not null
        //or set balances to default value if they are null
        chkBalance = BalancePref.getString(CHECKING_KEY, "0.00");
        savBalance = BalancePref.getString(SAVINGS_KEY, "0.00");
    }//end getPrefs
