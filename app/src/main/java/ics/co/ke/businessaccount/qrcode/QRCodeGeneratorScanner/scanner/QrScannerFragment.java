package ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.scanner;
...
import ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.qrdb.DBManager;

import static ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.generator.QrGenerator.cropImageFromPath;
import static ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.generator.QrGenerator.logger;
import static ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.qrdb.DBManager.getLastDataByColumn;
import static ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.qrdb.DatabaseHelper.CONTENT;
import static ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.qrdb.DatabaseHelper.PATH;
import static ics.co.ke.businessaccount.qrcode.QRCodeGeneratorScanner.qrdb.DatabaseHelper.TABLE_NAME;
...
public class QrScannerFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanResultImg = findViewById(R.id.scan_result_image);
