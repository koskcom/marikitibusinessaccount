...
package ics.co.ke.businessaccount.viewLicencedialog.licensesdialog;

import java.util.HashMap;
import java.util.Map;

import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.ApacheSoftwareLicense20;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.BSD2ClauseLicense;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.BSD3ClauseLicense;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.CreativeCommonsAttribution30Unported;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.CreativeCommonsAttributionNoDerivs30Unported;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.EclipsePublicLicense10;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.GnuGeneralPublicLicense20;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.GnuGeneralPublicLicense30;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.GnuLesserGeneralPublicLicense21;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.GnuLesserGeneralPublicLicense3;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.ISCLicense;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.License;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.MITLicense;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.MozillaPublicLicense11;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.MozillaPublicLicense20;
import ics.co.ke.businessaccount.viewLicencedialog.licensesdialog.licenses.SILOpenFontLicense11;
