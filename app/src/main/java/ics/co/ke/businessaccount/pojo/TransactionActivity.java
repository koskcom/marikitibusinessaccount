...
public class TransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText DepositET = findViewById(R.id.DepositEditText);
        ...
        Button WithdrawB = findViewById(R.id.WithdrawButton);
        //declare user withdraw input amount
        final EditText WithdrawET = findViewById(R.id.WithdrawEditText);
